...
kubectl logs -f -l app=details -c <container-name>
```

### https://stackoverflow.com/questions/47128586/how-to-delete-all-resources-from-kubernetes-one-time

> Stern, KubeCTX , kubeNS commands

```
stern details-v1 -c details
```
...
> ISTIO. list all CRD CustomResourceDefinitions & each of the the CRD:
